    ...
    async with httpx.AsyncClient() as httpx_client:
        ...
        send_message_payload: dict[str, Any] = {
            'message': {
                'role': 'user',
                'parts': [
                    {'kind': 'text', 'text': 'I have Blue Cross insurance policy ID BC123. I have sharp lower abdominal pain. Can you find me a gastroenterologist?'}
                ],
                'messageId': uuid4().hex,
            },
        }
        ...
        second_send_message_payload_multiturn: dict[str, Any] = {
            'message': {
                'role': 'user',
                'parts': [{'kind': 'text', 'text': 'I have Blue Cross insurance policy ID BC123. I have sharp lower abdominal pain. Can you find me a gastroenterologist?'}],
                'messageId': uuid4().hex,
                'taskId': task_id,
                'contextId': contextId,
            },
